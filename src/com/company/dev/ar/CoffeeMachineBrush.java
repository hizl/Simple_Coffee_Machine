...
public class CoffeeMachineBrush {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        CoffeeMachinee coffeeMachine = new CoffeeMachinee(400, 540, 120, 9, 550);
        coffeeMachine.start();
...
class CoffeeMachinee {
    ...
    CoffeeMachinee(int water, int milk, int beans, int cups, int money) {
        this.water = water;
        this.milk = milk;
        this.beans = beans;
        this.cups = cups;
